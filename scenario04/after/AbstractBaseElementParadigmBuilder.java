...
public class AbstractBaseElementParadigmBuilder<B extends AbstractBaseElementBuilder<B, E>, E extends BaseElement> extends AbstractBpmnModelElementBuilder<B, E> {
    public AbstractBaseElementParadigmBuilder(BpmnModelInstance modelInstance, E element, Class<?> selfType) {
    ...
    protected void setCoordinates(BpmnShape shape) {
        ...
        if (source != null) {
            ...
            x = sourceX + sourceWidth + AbstractBaseElementBuilder.SPACE;
    ...
    protected void resizeSubProcess(BpmnShape innerShape) {
        ...
        while (parent instanceof SubProcess) {
            ...
            if (subProcessShape != null) {
                ...
                double tmpWidth = innerX + innerWidth + AbstractBaseElementBuilder.SPACE;
                double tmpHeight = innerY + innerHeight + AbstractBaseElementBuilder.SPACE;

                if (innerY == subProcessY) {
                    subProcessBounds.setY(subProcessY - AbstractBaseElementBuilder.SPACE);
                    subProcessBounds.setHeight(subProcessHeight + AbstractBaseElementBuilder.SPACE);
                }
