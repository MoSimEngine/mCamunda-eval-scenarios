...
public abstract class DomainAbstractCatchEventBuilder<B extends ParadigmAbstractCatchEventBuilder<B, E>, E extends CatchEvent> extends ParadigmAbstractCatchEventBuilder<B, E> {
    protected DomainAbstractCatchEventBuilder(BpmnModelInstance modelInstance, E element, Class<?> selfType) {
