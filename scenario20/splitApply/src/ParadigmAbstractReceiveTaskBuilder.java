...
public abstract class ParadigmAbstractReceiveTaskBuilder<B extends ParadigmAbstractReceiveTaskBuilder<B>> extends AbstractTaskBuilder<B, ReceiveTask> {
    protected ParadigmAbstractReceiveTaskBuilder(BpmnModelInstance modelInstance, ReceiveTask element, Class<?> selfType) {
