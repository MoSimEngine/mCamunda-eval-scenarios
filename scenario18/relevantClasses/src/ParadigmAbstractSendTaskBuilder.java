...
public abstract class ParadigmAbstractSendTaskBuilder<B extends ParadigmAbstractSendTaskBuilder<B>> extends AbstractTaskBuilder<B, SendTask> {
    protected ParadigmAbstractSendTaskBuilder(BpmnModelInstance modelInstance, SendTask element, Class<?> selfType) {
     ...
     *
     * @param taskPriority
     * 		the task priority which should used for the external tasks
     * @return the builder object
     */
